...
g.test('dynamic offsets passed but not expected/compute pass').params(poptions('type', ['compute', 'renderpass', 'renderbundle'])).fn(async t => {
...
g.test('dynamic offsets match expectations in pass encoder').params(params().combine(poptions('type', ['compute', 'renderpass', 'renderbundle'])).combine([{
