...
g.test('creating texture view on a 2D non array texture').params([{
  _success: true
}, // default view works
{
  arrayLayerCount: 1,
...
g.test('creating texture view on a 2D array texture').params([{
  _success: true
}, // default view works
{
...
g.test('Using defaults validates the same as setting values for more than 1 array layer').params([{
  _success: true
}, {
...
g.test('Using defaults validates the same as setting values for only 1 array layer').params([{
  _success: true
}, {
  format: C.TextureFormat.RGBA8Unorm,
  _success: true
...
g.test('creating cube map texture view').params([{
...
g.test('creating cube map texture view with a non square texture').params([{
  dimension: C.TextureViewDimension.Cube,
  arrayLayerCount: 6
