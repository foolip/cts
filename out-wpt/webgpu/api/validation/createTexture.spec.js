...
g.test('validation of sampleCount').params([// TODO: Consider making a list of "valid"+"invalid" texture descriptors in capability_info.
{
  sampleCount: 0,
  _success: false
...
g.test('validation of mipLevelCount').params([{
  width: 32,
  height: 32,
  mipLevelCount: 1,
  _success: true
...
g.test('it is invalid to submit a destroyed texture before and after encode').params([{
...
g.test('it is invalid to have an output attachment texture with non renderable format').params(poptions('format', kTextureFormats)).fn(async t => {
